...
import { getAllProjects, getPostBySlug } from "@/lib/content";
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10">
      ...
      <header className="mb-10 max-w-3xl">
        ...
        {/* GitHub Link */}
        {post.meta.github_link && (
          <a
            href={post.meta.github_link}
            target="_blank"
            rel="noopener noreferrer"
            className="mt-5 inline-flex items-center gap-2 rounded-lg border border-slate-700 bg-slate-800/80 px-4 py-2.5 text-sm font-medium text-slate-300 hover:bg-slate-700 hover:text-white transition-all"
          >
